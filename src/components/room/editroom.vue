    ...
    <div>
        <Form @submit="submitRoom" :validation-schema="roomFormSchema">
            ...
            <div class="form-group">
                ...
                <Field name="imgURL" type="text" class="form-control" v-model="roomLocal.imgURL" required />
        ...
        <router-link :to="{ name: 'admin-room', params: { id: hotelId } }">
...
export default {
    ...
    data() {
        ...
        const roomFormSchema = yup.object().shape({
            ...
            hotel_id: yup.string().required("ID khách sạn phải có giá trị."),
        });
    ...
    created() {
        ...
        this.roomLocal.hotel_id = this.hotelId;
