<template>
  <div>
    <div style="display: flex; align-items: center; margin-bottom: 50px;">
      ...
      <h2 style="margin-left: 10px;">Điểm đến hot Đông Nam Á</h2>
    </div>
    <div class="button-container" style="display: flex; align-items: center; margin-bottom: 50px; margin-left: 16px;">
      <button class="btn" :class="{ 'btn-info': showImages1, 'btn-secondary': !showImages1 }"
        @click="showImages(images1, 1)" @mouseover="highlightButton(1)" @mouseleave="resetButton(1)">Singapore</button>
      <button class="btn" :class="{ 'btn-info': showImages2, 'btn-secondary': !showImages2 }"
        @click="showImages(images2, 2)" @mouseover="highlightButton(2)" @mouseleave="resetButton(2)">Kualar
        Lumpua</button>
      <!-- Add 6 more buttons here -->
      <button class="btn" :class="{ 'btn-info': showImages3, 'btn-secondary': !showImages3 }"
        @click="showImages(images3, 3)" @mouseover="highlightButton(3)" @mouseleave="resetButton(3)">Bali</button>

    </div>
    <!-- Similarly, add divs and buttons for each group of images -->
