                ...
                <div class="ks col-sm-12">
                    ...
                    <div class="kt">
                        ...
                        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            </svg> Đặt sớm mã giảm 500k + công dồn tới 80k </p>
                        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <div class="bt">
                        <div class="thpd">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                                class="icon mr-2 icon-tabler icons-tabler-outline icon-tabler-discount">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M9 15l6 -6" />
                                <circle cx="9.5" cy="9.5" r=".5" fill="currentColor" />
                                <circle cx="14.5" cy="14.5" r=".5" fill="currentColor" />
                        ...
                        <div class="thpd" style="width: 121px;
    padding-top: 54px;">
                        ...
                        <div class="thpd">
                            ...
                            <div class="tt">
                                <button class="btn bnt-warning"> Chọn phòng
                ...
                <div class="ks col-sm-12">
                    ...
                    <div class="kt">
                        ...
                        <p>Máy lạnh, Nhà hàng, Hồ bơi, Lễ tân 24h, Chỗ đậu xe, Thang máy</p>
                        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                                class="icon icon-tabler icons-tabler-outline icon-tabler-discount">
