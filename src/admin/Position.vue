    ...
    <div class="position">
        ...
        <table class="table align-middle mb-0 bg-white">
            <thead class="bg-light" style="text-align: center;">
                <tr>
                    <h3 style="margin-right: 116px;">Tỉnh Thành có khách sạn của hệ thống</h3>
                    <!-- <th>Mô tả</th> -->
                    <!-- <th>Giá</th> -->
            ...
            <div class="row">
                <div class="col-sm-4" v-for="product in products" :key="product._id">
                    <td style="height: 200px;">
                        <router-link :to="{ name: 'admin-hotel', params: { id: product._id } }"
                            style="color: black; text-decoration: none; font-weight: 500;">
                            <div class="d-flex align-items-center">
                                <img :src="product.imgURL" alt=""
                                    style="width: 108px; height: 108px; margin-right: 18px" class="rounded-circle" />
                                <div class="ms-3">
